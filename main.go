...
type Config struct {
	...
	// Message
	WebhookURL      stepconf.Secret "https://chat.googleapis.com/v1/spaces/AAAA84zJtak/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=Wp0Cn-q4E6CZNibXc6SvG7jlP1WEibNg_LKiMtgQOeQ%3D"
	AppTitle        string          "BITRISE_APP_TITLE"
